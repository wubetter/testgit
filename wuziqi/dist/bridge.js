...
module.exports = AI;
},{"./board.js":2,"./config.js":5,"./negamax.js":10,"./role.js":12}],2:[function(require,module,exports){
...
Board.prototype.init = function(sizeOrBoard){
    ...
    var size;
    //如果sizeOrBoard 是 board（保存的棋盘）则直接赋值
    if(sizeOrBoard.length){
        this.board = sizeOrBoard;
        size = this.board.length;
    }else{//如果 sizeOrBoard 是数字大小 则 初始化 this.board (二维数组)
        size = sizeOrBoard;
        this.board = [];
...
/** 下棋子
 *  @parmas p       [description]棋子坐标[x,y]
 *  @parmas role    [description]角色标记  1 棋手 2 电脑
 *  @parmas record  [description]是否记录当前棋子步数
 */
Board.prototype.put = function(p,role,record){
    this.board[p[0]][p[1]] = role;//每下一棋子记录当前位置的角色 1 棋手，2电脑 0 还没有棋子
...
//每下一次棋子 更新下改棋子附近空位子的分数
Board.prototype.updateScore = function(p){
    var self = this,
        radius = 8,//区域半径 更新以当前棋子为中心，8个单位远的位置的得分
        board = this.board,
...
},{"./config.js":5,"./evaluate-point.js":8,"./neighbor.js":11,"./role.js":12,"./score.js":13,"./zobrist.js":16}],3:[function(require,module,exports){
...
},{"./config.js":5,"./debug.js":7,"./evaluate-point.js":8,"./neighbor.js":11,"./role.js":12,"./score.js":13,"./win.js":15,"./zobrist.js":16}],5:[function(require,module,exports){
module.exports = {
  searchDeep: 6,  //搜索深度
...
},{"./score.js":13}],7:[function(require,module,exports){
var debug = {};
...
module.exports = s;
},{"./count-to-type.js":6,"./role.js":12,"./type-to-Score.js":14}],9:[function(require,module,exports){
var threshold = 1.1;
...
},{"./board.js":2,"./checkmate-fast.js":4,"./config.js":5,"./debug.js":7,"./math.js":9,"./role":12,"./score.js":13}],11:[function(require,module,exports){
var R = require("./role");
//有邻居
...
},{"./score.js":13}],15:[function(require,module,exports){
var R = require("./role.js");
...
module.exports = w;
},{"./role.js":12}],16:[function(require,module,exports){
var R = require('./role.js');
...
Zobrist.prototype.init = function(){
    this.com = [];
    this.hum = [];
    for(var i=0,len = Math.pow(this.size,2);i<len;i++){
